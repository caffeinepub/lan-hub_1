...
import type { ExternalBlob as _ExternalBlob, FileMetadata as _FileMetadata, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getFile(arg0: FileId): Promise<{
        metadata: FileMetadata;
        blob: ExternalBlob;
    } | null> {
        if (this.processError) {
    ...
    async uploadFile(arg0: ExternalBlob, arg1: string, arg2: bigint, arg3: string): Promise<FileId> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadFile(await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [{
    ...
    return value.length === 0 ? null : await from_candid_record_n9(_uploadFile, _downloadFile, value[0]);
}
